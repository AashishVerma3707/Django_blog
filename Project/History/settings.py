...
SECRET_KEY = 'django-insecure-(3gt%ri@x$s*k(iw=qg8cv@srk)ph%!#uamw9nofru_0j=%by$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'history-blog.herokuapp.com']
import os
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',"blog","Accounts"
